...
echo -----------------------------
echo Installing RPyTkGUICreator
echo -----------------------------
echo Please wait...
echo.
...
echo Starting RPyTkGUICreator Installation...
...
echo Creating RPyTkGUICreator Python Virtual Enviroment...
python -m venv .\venv
...
echo Installing RPyTkGUICreator Python Packages and Requirements...
...
echo Finished Installation of Packages and Requirements for RPyTkGUICreator.
echo Thanks for installing.
echo Type: 'run.bat' to Run RPyTkGUICreator.
